...
const Loader = () => {
  return (
	...
	<div className="preloader__text" style={{color:'#3498db'}}>
		<p className="preloader__msg" >Fetching...</p>
		<p className="preloader__msg preloader__msg--last">This may take a Few Seconds.</p>
	</div>
</div>
    </div>
  )
