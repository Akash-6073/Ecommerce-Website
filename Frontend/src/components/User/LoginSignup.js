...
const LoginSignup = () => {
  const alert = useAlert();
    ...
    const loginSubmit = (e) => {
        e.preventDefault();
        dispatch(login(loginEmail, loginPassword)); // Dispatch login action on submit
    };
    ...
    const registerSubmit = (e) => {
        ...
        dispatch(register(myForm)); // Dispatch register action on submit
    };
    ...
    // Tab switch handling between Login and Register forms
